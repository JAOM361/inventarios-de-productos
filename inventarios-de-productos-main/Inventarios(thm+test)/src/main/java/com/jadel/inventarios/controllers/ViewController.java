...
public String procesarInicioSesion(
    ...
    return usuarioService.buscarPorCorreo(correo)
        ...
        .map(u -> "redirect:/index") // si coincide → entra
        .orElse("redirect:/inicio?error=true"); // si no → error
}
...
public String mostrarFormularioRegistro(Model model) {
    ...
    return "registro"; // nombre del archivo registrar.html en /templates
}

@PostMapping("/registro")
public String procesarRegistro(@ModelAttribute Usuario usuario) {
    usuarioService.saveUsuario(usuario);
    return "redirect:/index"; // ← redirige al index después del registro
}
